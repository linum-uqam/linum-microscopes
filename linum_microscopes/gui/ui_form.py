...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionXYZ_Stage = QAction(MainWindow)
        self.actionXYZ_Stage.setObjectName(u"actionXYZ_Stage")
        ...
        self.menuConfiguration.addAction(self.actionXYZ_Stage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionXYZ_Stage.setText(QCoreApplication.translate("MainWindow", u"XYZ Stage", None))
        self.actionSet_current_position_as_vibratome_position.setText(QCoreApplication.translate("MainWindow", u"Set current position as vibratome position", None))
